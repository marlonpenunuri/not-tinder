...
import com.nu9ve.quests.databinding.FragmentTutorialParentBinding
...
class TutorialParentFragment : DaggerFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val firstFragment = TutorialPageFragment.newInstance(
            1,
            instructionsArray[0]
        )
        val secondFragment =
        ...
        val thirdFragment = TutorialPageFragment.newInstance(
            3,
            instructionsArray[2]
        )
        val fourthFragment =
